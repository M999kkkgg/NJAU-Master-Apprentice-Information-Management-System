...
namespace NJAUST_APP
{
    public partial class Form2_5 : Form
    {
        ...
        private void FLASH_Click(object sender, EventArgs e)
        {
            ...
            string tname = "null";
            string fname = "null";
            com.CommandText = "select distinct MTName,FName from MASTER_RECORD_Table,FIELD_Table where Fid=MFid and Flag='True' and MSName='" + NAME.Text + "'";
